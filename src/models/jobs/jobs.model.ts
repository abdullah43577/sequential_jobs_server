    ...
    applicants: [
      {
        ...
        status: { type: String, enum: ["applied", "shortlisted", "interview_invite_sent", "interview_scheduled", "interview_completed", "offer_sent", "hired", "rejected", "medical_scheduled", "medical_completed"], default: "applied" },
      },
    ],
