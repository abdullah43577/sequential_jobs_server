    ...
    applicants: [
      {
        ...
        status: { type: String, enum: ["applied", "shortlisted", "interview_invite_sent", "interview_scheduled", "interview_completed", "has_offer", "hired", "rejected", "medical_scheduled", "medical_completed"], default: "applied" },
      },
    ],
