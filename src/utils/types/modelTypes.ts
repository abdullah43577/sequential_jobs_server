...
export interface IJob {
  ...
  description: string;
  applicants: { applicant: Types.ObjectId; date_of_application?: Date; status: "applied" | "shortlisted" | "interview_invite_sent" | "interview_scheduled" | "interview_completed" | "offer_sent" | "hired" | "rejected" }[];
  is_live: boolean;
